...
@Autonomous(name="Auto_Drop_Marker_Stop_From_Crater", group="Wired Woodman")
public class Auto_Drop_Marker_Stop_From_Crater extends AutoLinearAbstract_2018 {
    ...
    public void runOpMode() {
        ...
        while(!driveTrain.isMoveDone(MAX_DRIVE_TRAIN_POSITION_ERROR_INCHES )) {
            ...
            //Go To Crater
            driveTrain.goRoundToTarget(34, 34, DRIVE_TRAIN_DEFAULT_SPEED);
            while (!driveTrain.isMoveDone(MAX_DRIVE_TRAIN_POSITION_ERROR_INCHES )) {
